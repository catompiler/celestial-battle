...
${OBJECTDIR}/_ext/1390850504/display.o: ../src/display/display.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1390850504/display.o ../src/display/display.cpp

${OBJECTDIR}/_ext/241037705/win_window.o: ../src/window/win/win_window.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/241037705
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/241037705/win_window.o ../src/window/win/win_window.cpp

${OBJECTDIR}/_ext/62598791/object.o: ../src/object/object.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/62598791
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/62598791/object.o ../src/object/object.cpp

${OBJECTDIR}/_ext/1019042359/osal.o: ../src/osal/osal.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1019042359
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1019042359/osal.o ../src/osal/osal.cpp
...
${OBJECTDIR}/_ext/1964180579/win_input.o: ../src/input/win/win_input.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1964180579/win_input.o ../src/input/win/win_input.cpp

${OBJECTDIR}/_ext/960476113/x11_display.o: ../src/display/x11/x11_display.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/960476113
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/960476113/x11_display.o ../src/display/x11/x11_display.cpp

${OBJECTDIR}/_ext/1534683872/event.o: ../src/event/event.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1534683872
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1534683872/event.o ../src/event/event.cpp

${OBJECTDIR}/_ext/241038541/x11_window.o: ../src/window/x11/x11_window.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/241038541
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/241038541/x11_window.o ../src/window/x11/x11_window.cpp
...
${OBJECTDIR}/_ext/1964181415/x11_input.o: ../src/input/x11/x11_input.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1964181415/x11_input.o ../src/input/x11/x11_input.cpp

${OBJECTDIR}/_ext/173017642/window.o: ../src/window/window.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/173017642
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/173017642/window.o ../src/window/window.cpp
...
${OBJECTDIR}/_ext/1060664647/x11_glcontext.o: ../src/glcontext/x11/x11_glcontext.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1060664647/x11_glcontext.o ../src/glcontext/x11/x11_glcontext.cpp
...
${OBJECTDIR}/_ext/659861322/log.o: ../src/log/log.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/659861322/log.o ../src/log/log.cpp

${OBJECTDIR}/_ext/662815568/glcontext.o: ../src/glcontext/glcontext.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/662815568
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/662815568/glcontext.o ../src/glcontext/glcontext.cpp
...
${OBJECTDIR}/_ext/1060663811/win_glcontext.o: ../src/glcontext/win/win_glcontext.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1060663811/win_glcontext.o ../src/glcontext/win/win_glcontext.cpp

${OBJECTDIR}/_ext/960476949/win_display.o: ../src/display/win/win_display.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/960476949
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/960476949/win_display.o ../src/display/win/win_display.cpp

${OBJECTDIR}/_ext/1531217328/input.o: ../src/input/input.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1531217328
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1531217328/input.o ../src/input/input.cpp
