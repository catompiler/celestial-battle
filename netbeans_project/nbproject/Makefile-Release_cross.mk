...
${OBJECTDIR}/_ext/337893252/engine.o: ../src/engine/engine.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../src/ -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/337893252/engine.o ../src/engine/engine.cpp
...
${OBJECTDIR}/_ext/1316242397/settings.o: ../src/settings/settings.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../src/ -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1316242397/settings.o ../src/settings/settings.cpp
